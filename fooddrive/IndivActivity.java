                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            //IndivData indivData= new IndivData(Name,Addr, Pswd, Contact, Email,categ,0);
                            ProfileData profileData = new ProfileData(Name,Addr,"none", "none", "none", Pswd, Contact, Email,categ,0);

                            FirebaseUser user = firebaseAuth.getCurrentUser();
                            //databaseReference.child("Registration").child(user.getUid()).setValue(indivData);
